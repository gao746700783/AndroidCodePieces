...
import com.example.myapplication.extension.SVGALoadHelper
...
//    if (TextUtils.isEmpty(svgaAssetsOrUrl)) {
//        return
//    }
//    if (svgaAssetsOrUrl.startsWith("http:") || svgaAssetsOrUrl.startsWith("https:")) {
//        loadSVGAFromUrl(view, svgaAssetsOrUrl)
//        return
//    }
//
//    loadSVGAFromAssets(view, svgaAssetsOrUrl)
}
